...
- **$0.55 — hosted · Together.** Part of the week's work routed to a hosted OpenAI-compatible endpoint (MiniMax M3). It handled a smaller volume than the Anthropic path, so read it as what that path billed, not a like-for-like race.
- **$103.57 — Anthropic · 7 days.** The Anthropic path (Sonnet + Haiku) for the same period. The all-provider total for the week is $104.12, once the $0.55 Together run is added.
