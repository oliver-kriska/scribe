...
- Chapter title (for the `chapter` field): {{CHAPTER_TITLE}}
...
## Chapter chunk body (this is your input)
...
1. Read the chunk body end to end. Do not infer beyond it — your scope is this chapter.

2. Identify topics worth their own wiki page: a named tool, decision, pattern, solution, research finding, person, concept that originates or is materially developed in this chapter. Skip cross-references to topics introduced elsewhere.
